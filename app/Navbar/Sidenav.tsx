...
const Sidenav = () => {
  ...
  const [width, setWidth] = useState(getWidth(path.split("/")[1]));
    ...
    <div className="laptop:h-full  laptop:w-[16rem]  w-full sticky z-[99]  left-0 laptop:bg-beige-600 bg-[gray]/25  text-dark px-4 border-box flex flex-col gap-4 justify-between overflow-x-scroll hidescrollbar">
      ...
      >
        ...
        <div
          ...
          className={` h-[2px] absolute laptop:hidden bottom-0 grid place-items-center box-border transition-all bg-[green]`}
        >
          {/* <div
            className={`w-full h-1/2 bg-blue-600 rounded-tr rounded-br transition-all -left-[2px] duration-300 left-0 z-10 border-b-2 box-border grid place-items-center ${
              route === path ? "border-dark-100" : "border-dark-100/25"
            }`}
          ></div> */}
        </div>
