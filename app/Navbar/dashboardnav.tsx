...
const Dashboardnav = () => {
  return (
    <div className="w-screen px-4 laptop:h-[4rem] p-2 laptop:p-0 bg-beige-700 fixed top-0  flex justify-between items-center text-dark gap-4 ">
      <div className="w-full tablet:flex items-center   grid gap-4 ">
